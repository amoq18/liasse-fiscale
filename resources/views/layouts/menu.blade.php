    ...
    <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="submenu">
                    <a href="#" class="{{ Request::is('exercice*') ? 'active font-weight-bold' : '' }}"><i class="fe fe-document"></i> <span> Exercice</span> <span class="menu-arrow"></span></a>
                    <ul style="display: none;">
                        <li><a href="{{ route('exercice.create') }}" class="{{ Request::is('exercice*') ? 'bg-primary-light font-weight-bold' : '' }}">Créer</a></li>
