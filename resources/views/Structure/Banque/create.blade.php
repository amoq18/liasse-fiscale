    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header bg-primary">
                <h4 class="card-title text-center text-light">Créer une Banque</h4>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="code_banque" class="form-control text-uppercase @error('code_banque') is-invalid @enderror" value="{{ old('code_banque') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input required type="text" name="denomination_banque" class="form-control text-capitalize @error('denomination_banque') is-invalid @enderror" value="{{ old('denomination_banque') }}">
