        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="card-title text-center text-light">Informations générales sur l'Entreprise {{ $entreprise->denomination }}</h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label> Cigle:</label>
                                <input disabled type="text" name="cigle_entreprise"
                                    value="{{ old('cigle_entreprise', $entreprise->cigle) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" name="denomination_entreprise"
                                    value="{{ old('denomination_entreprise', $entreprise->denomination) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" name="forme_juridique_entreprise"
                                    value="{{ old('forme_juridique_entreprise', $entreprise->forme_juridique) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" name="boite_postale_entreprise"
                                            value="{{ old('boite_postale_entreprise', $entreprise->boite_postale) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="number" min="0" name="code_contribuable_entreprise"
                                            value="{{ old('code_contribuable_entreprise', $entreprise->code_contribuable) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="number" min="0" name="numero_repertoire_entreprise"
                                    value="{{ old('numero_repertoire_entreprise', $entreprise->numero_repertoire) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" name="nom_professionnel_salarier_entreprise"
                                    value="{{ old('nom_professionnel_salarier_entreprise', $entreprise->nom_professionnel_salarier) }}"
                            ...
                            <div class="form-group">
                                <label> Email:</label>
                                <input disabled type="email" name="email_entreprise"
                                    value="{{ old('email_entreprise', $entreprise->email) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" name="activite_principale_entreprise"
                                    value="{{ old('activite_principale_entreprise', $entreprise->activite_principale) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" name="centre_impots_entreprise"
                                    value="{{ old('centre_impots_entreprise', $entreprise->centre_impots) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> IFU:</label>
                                        <input disabled type="number" min="0" name="ifu_entreprise"
                                            value="{{ old('ifu_entreprise', $entreprise->ifu) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" name="registre_commerce_entreprise"
                                            value="{{ old('registre_commerce_entreprise', $entreprise->registre_commerce) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> N° CNSS:</label>
                                        <input disabled type="number" min="0" name="numero_cnss_entreprise"
                                            value="{{ old('numero_cnss_entreprise', $entreprise->numero_cnss) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" name="telephone_entreprise"
                                            value="{{ old('telephone_entreprise', $entreprise->telephone) }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Pays:</label>
                                        <input disabled type="text" name="pays_entreprise"
                                            value="{{ old('pays_entreprise', 'Bénin') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Ville:</label>
                                        <input disabled type="text" name="ville_entreprise"
                                            value="{{ old('ville_entreprise', $entreprise->ville) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input disabled type="text" name="quartier_entreprise"
                                    value="{{ old('quartier_entreprise', $entreprise->quartier) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> N° Rue:</label>
                                        <input disabled type="text" name="numero_rue_entreprise"
                                            value="{{ old('numero_rue_entreprise', $entreprise->numero_rue) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> N° Lot:</label>
                                        <input disabled type="text" name="numero_lot_entreprise"
                                            value="{{ old('numero_lot_entreprise', $entreprise->numero_lot) }}"
                            ...
                            <div class="form-group">
                                <label> Nom:</label>
                                <input disabled type="text" name="nom_gerant_entreprise"
                                    value="{{ old('nom_gerant_entreprise', $entreprise->nom_gerant) }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Adresse:</label>
                                        <input disabled type="text" name="adresse_gerant_entreprise"
                                            value="{{ old('adresse_gerant_entreprise', $entreprise->adresse_gerant) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input disabled type="text" name="qualification_gerant_entreprise"
                                            value="{{ old('qualification_gerant_entreprise', $entreprise->qualification_gerant) }}"
                            ...
                            <div class="form-group">
                                <label> Nom:</label>
                                <input disabled type="text" name="nom_expert_entreprise"
                                    value="{{ old('nom_expert_entreprise', $entreprise->nom_expert) }}"
                            ...
                            <div class="form-group">
                                <label> Adresse:</label>
                                <input disabled type="text" name="adresse_expert_entreprise"
                                    value="{{ old('adresse_expert_entreprise', $entreprise->adresse_expert) }}"
                            ...
                            <div class="form-group">
                                <label> Nom:</label>
                                <input disabled type="text" name="nom_signataire_entreprise"
                                    value="{{ old('nom_signataire_entreprise', $entreprise->nom_signataire) }}"
                            ...
                            <div class="form-group">
                                <label> Prénoms:</label>
                                <input disabled type="text" name="prenom_signataire_entreprise"
                                    value="{{ old('prenom_signataire_entreprise', $entreprise->prenom_signataire) }}"
                            ...
                            <div class="form-group">
                                <label> Qualité:</label>
                                <input disabled type="text" name="qualite_signataire_entreprise"
                                    value="{{ old('qualite_signataire_entreprise', $entreprise->qualite_signataire) }}"
