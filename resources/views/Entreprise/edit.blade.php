    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Modifier les informations sur l'Entreprise</h4>
            </div>
            <div class="card-body">
                <form action="{{ route('entreprise.edit', $entreprise->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                <label> Cigle:</label>
                                <input type="text" name="cigle_entreprise" class="form-control" value="{{ $entreprise->cigle }}" aut />
                            </div>
                            <div class="form-group">
                                <label> Denomination:</label>
                                <input type="text" name="denomination_entreprise" class="form-control" value="{{ $entreprise->denomination }}" aliqu />
                            </div>
                            <div class="form-group">
                                <label> Forme juridique:</label>
                                <input type="text" name="forme_juridique_entreprise" class="form-control" value="{{ $entreprise->forme_juridique }}" />
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Boîte postale:</label>
                                        <input type="text" name="boite_postale_entreprise" class="form-control" value="{{ $entreprise->boite_postale }}" deser />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Ville:</label>
                                        <input type="text" name="ville_entreprise" class="form-control" value="{{ $entreprise->ville }}" quod es />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="nom_professionnel_salarier_entreprise" class="form-control" value="{{ $entreprise->nom_professionnel_salarier }}" r />
                            </div>
                            <div class="form-group">
                                <label> Email:</label>
                                <input type="text" name="email_entreprise" class="form-control" value="{{ $entreprise->email }}@mailinator.com" />
                            </div>
                            <div class="form-group">
                                <label> Activité principale:</label>
                                <input type="text" name="activite_principale_entreprise" class="form-control" value="{{ $entreprise->activite_principale }}" no />
                            </div>
                            <div class="form-group">
                                <label> Centre des Impôts:</label>
                                <input type="text" name="centre_impots_entreprise" class="form-control" value="{{ $entreprise->centre_impots }}" blandi />
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="registre_commerce_entreprise" class="form-control" value="{{ $entreprise->registre_commerce }}" est />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> N° CNSS:</label>
                                        <input type="text" name="numero_cnss_entreprise" class="form-control" value="{{ $entreprise->numero_cnss }}" duc />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label> Téléphone:</label>
                                        <input type="text" name="telephone_entreprise" class="form-control" value="+{{ $entreprise->telephone }}" (141) 908-4579 />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="quartier_entreprise" class="form-control" value="{{ $entreprise->quartier }}" tempo />
                            </div>
                            <div class="form-group">
                                <label> N° Lot:</label>
                            ...
                            <div class="form-group">
                                <label> Nom:</label>
                                <input type="text" name="nom_gerant_entreprise" class="form-control" value="{{ $entreprise->nom_gerant }}" s />
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                    ...
                    <div class="text-right">
                        <a href="{{ route('entreprise.index') }}" class="btn btn-danger"><i class="fa fa-arrow-left"></i> Fermer</a>
